...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\UserRepositoryInterface' => \App\Repositories\UserRepository::class,
    ...
    override(\config(), map([
            ...
            'custom.custom.mySkins' => 'string',
            'custom.custom.hasSemiDark' => 'boolean',
            ...
            'filesystems.links./Users/rezky/Documents/Work/protein_attendence/public/storage' => 'string',
            ...
            'variables.creatorName' => 'string',
            'variables.creatorUrl' => 'string',
            'variables.templateName' => 'string',
            'variables.templateSuffix' => 'string',
            'variables.templateVersion' => 'string',
            'variables.templateFree' => 'boolean',
            'variables.templateDescription' => 'string',
            'variables.templateKeyword' => 'string',
            'variables.licenseUrl' => 'string',
            'variables.livePreview' => 'string',
            'variables.productPage' => 'string',
            'variables.support' => 'string',
            'variables.moreThemes' => 'string',
            'variables.ogTitle' => 'string',
            'variables.ogImage' => 'string',
            'variables.ogType' => 'string',
            'variables.documentation' => 'string',
            'variables.generator' => 'string',
            'variables.changelog' => 'string',
            'variables.repository' => 'string',
            'variables.gitRepo' => 'string',
            'variables.gitRepoAccess' => 'string',
            'variables.githubFreeUrl' => 'string',
            'variables.facebookUrl' => 'string',
            'variables.twitterUrl' => 'string',
            'variables.githubUrl' => 'string',
            'variables.dribbbleUrl' => 'string',
...
'app.previous_keys','app.maintenance.driver','app.maintenance.store','app.providers','app.aliases.Helper',
...
'cache.stores.octane.driver','cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','custom.custom.myLayout',
'custom.custom.myTheme','custom.custom.mySkins','custom.custom.hasSemiDark','custom.custom.myRTLMode','custom.custom.hasCustomizer',
'custom.custom.displayCustomizer','custom.custom.contentLayout','custom.custom.navbarType','custom.custom.footerFixed','custom.custom.menuFixed',
'custom.custom.menuCollapsed','custom.custom.headerType','custom.custom.showDropdownOnHover','custom.custom.customizerControls','database.default',
...
'datatables.columns.whitelist','datatables.json.header','datatables.json.options','datatables.callback','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links./Users/rezky/Documents/Work/protein_attendence/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'variables.creatorName','variables.creatorUrl','variables.templateName','variables.templateSuffix','variables.templateVersion',
'variables.templateFree','variables.templateDescription','variables.templateKeyword','variables.licenseUrl','variables.livePreview',
'variables.productPage','variables.support','variables.moreThemes','variables.ogTitle','variables.ogImage',
'variables.ogType','variables.documentation','variables.generator','variables.changelog','variables.repository',
'variables.gitRepo','variables.gitRepoAccess','variables.githubFreeUrl','variables.facebookUrl','variables.twitterUrl',
'variables.githubUrl','variables.dribbbleUrl','variables.instagramUrl','livewire.class_namespace','livewire.view_path',
...
'livewire.pagination_theme','datatables-fractal.includes','datatables-fractal.serializer','ide-helper.filename','ide-helper.models_filename',
...
'login','login.store','logout','user-profile-information.update','user-password.update',
'password.confirm','password.confirmation','password.confirm.store','livewire.update','livewire.upload-file','livewire.preview-file','pages-home',
'pages-page-2','pages-misc-error','admin.dashboard',
'admin.users.index','admin.users.store','admin.users.show','admin.users.update','admin.users.destroy',
'admin.users.assign-roles','storage.local',);
        registerArgumentsSet('views', 
'_partials.macros','components.feedback-alert','content.authentications.auth-register-basic','content.authentications.login','content.pages.admin.AdminDashboard',
'content.pages.admin.users.index','content.pages.admin.users.partials.actions','content.pages.pages-home','content.pages.pages-misc-error','content.pages.pages-page2',
'layouts.blankLayout','layouts.commonMaster','layouts.contentNavbarLayout','layouts.horizontalLayout','layouts.layoutFront',
'layouts.layoutMaster','layouts.sections.footer.footer','layouts.sections.footer.footer-front','layouts.sections.menu.horizontalMenu','layouts.sections.menu.submenu',
'layouts.sections.menu.verticalMenu','layouts.sections.navbar.navbar','layouts.sections.navbar.navbar-front','layouts.sections.navbar.navbar-partial','layouts.sections.scripts',
'layouts.sections.scriptsFront','layouts.sections.scriptsIncludes','layouts.sections.scriptsIncludesFront','layouts.sections.styles','layouts.sections.stylesFront',
